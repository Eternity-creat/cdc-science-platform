      ...
      <div className={cn('flex items-center border-b border-sidebar-border px-4', collapsed ? 'justify-center py-4' : 'gap-3 pt-[4.25rem] pb-5 px-5')}>
        ...
        {!collapsed && (
          <div className="min-w-0 animate-fade-in">
            <div className="whitespace-nowrap text-[17px] font-bold tracking-normal text-sidebar-foreground">科普文章生成系统</div>
          </div>
        )}
      </div>
            ...
            {navItems.map(({ to, icon: Icon, label }) => {
              ...
              const linkContent = (
                <NavLink
                  ...
                  onClick={onNavClick}
                className={cn(
                    'flex items-center gap-3 rounded-lg px-3 py-2.5 text-[13px] w-full whitespace-nowrap',
