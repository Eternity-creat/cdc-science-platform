  ...
  return (
    <div className="p-6 lg:p-8 page-enter">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        {loading
          ...
          : stats.map((s, idx) => {
              const Icon = s.icon;
              return (
              <Card key={s.label} className="p-5 relative overflow-hidden enter-scale transition-shadow duration-300 hover:shadow-[var(--shadow-elevated)]" style={{ '--enter-delay': `${idx * 60}ms` }}>
      ...
      {loading ? (
        ...
        <div className="bg-card border border-border rounded-[var(--radius-xl)] shadow-[var(--shadow-card)] overflow-hidden enter" style={{ '--enter-delay': '280ms' }}>
          <Table>
            <TableHeader>
              <TableRow className="bg-primary/5">
                <TableHead className="w-[40px]" />
                <TableHead className="text-center">主题</TableHead>
                <TableHead className="w-[140px] text-center">模板</TableHead>
                ...
                return (
                  <Fragment key={a.id}>
                    ...
                    >
                      ...
                      <TableCell className="py-3">
                        <span className="text-helper text-muted-foreground">{a.templateName || '-'}</span>
                      </TableCell>
                      <TableCell className="py-3">
                    ...
                    {isExpanded && (
                      <TableRow className="bg-accent/20 row-expand-enter">
                        <TableCell colSpan={6} className="py-3 px-6">
                          <div className="flex items-center gap-6 text-helper text-muted-foreground pl-[88px]">
